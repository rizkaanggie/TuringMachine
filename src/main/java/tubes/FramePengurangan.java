...
public class FramePengurangan extends JFrame {
	...
	public FramePengurangan() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(FramePengurangan.class.getResource("/img/logo.png")));
		setTitle("Operasi Pengurangan");
		...
		panel.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Pengurangan", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		btnResult.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				output = Pengurangan.start(Integer.valueOf(input_1), Integer.valueOf(input_2));
				textSteps.setText(String.valueOf(currentStep));
