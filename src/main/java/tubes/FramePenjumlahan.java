...
public class FramePenjumlahan extends JFrame {
	...
	public FramePenjumlahan() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(FramePenjumlahan.class.getResource("/img/logo.png")));
		...
		panel.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Penjumlahan", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		btnResult.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				output = Penjumlahan.start(Integer.valueOf(input_1), Integer.valueOf(input_2));
				textSteps.setText(String.valueOf(currentStep));
	...
	public void setView(int stepAt) {
		...
		txtArea.append("\n");
		int result = output.getResultAdd();
		txtArea.append("────────────────────────────────────────────────────────────────────────────────────\n");
