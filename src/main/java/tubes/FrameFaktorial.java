...
public class FrameFaktorial extends JFrame {
	...
	public FrameFaktorial() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(FrameFaktorial.class.getResource("/img/logo.png")));
		setTitle("Operasi Faktorial");
		...
		panel.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Faktorial", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		btnResult.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				output = Faktorial.start(Integer.valueOf(input));
				textSteps.setText(String.valueOf(currentStep));
