...
public class FrameModulo extends JFrame {
	...
	public FrameModulo() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(FrameModulo.class.getResource("/img/logo.png")));
		setTitle("Operasi Modulo");
		...
		panel.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Modulo", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		btnResult.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String input_1 = textField_2.getText();
				
				output = Modulo.start(Integer.valueOf(input_1), Integer.valueOf(input_2));
				textSteps.setText(String.valueOf(currentStep));
