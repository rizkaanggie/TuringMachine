...
public class FramePembagian extends JFrame {
	...
	public FramePembagian() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(FramePembagian.class.getResource("/img/logo.png")));
		setTitle("Operasi Pembagian");
		...
		panel.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Pembagian", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		btnResult.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				output = Pembagian.start(Integer.valueOf(input_1), Integer.valueOf(input_2));
				textSteps.setText(String.valueOf(currentStep));
